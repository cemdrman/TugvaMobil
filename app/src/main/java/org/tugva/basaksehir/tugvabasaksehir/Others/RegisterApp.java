...
import org.tugva.basaksehir.tugvabasaksehir.Activitys.MainActivity;
import org.tugva.basaksehir.tugvabasaksehir.Activitys.SplashScreen;
...
public class RegisterApp extends AsyncTask<Void, Void, String> {
    ...
    final String PROJECT_ID = "334901012437";//Bu değer Google Apı sayfasında Owerview menüsünde(Giriş sayfası) yukarıda yer alır. Project Number:987... şeklinde
    String regid = null;
    ...
    private void sendRegistrationIdToBackend() {//Sunucuya regid değerini gönderecek method
        ...
        URI url = null;
        try {
            url = new URI("http://eminebabacan.esy.es/gmc/register.php?regId=" + regid);
